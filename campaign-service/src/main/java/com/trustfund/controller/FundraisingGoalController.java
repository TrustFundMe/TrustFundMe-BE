...
public class FundraisingGoalController {
    ...
    @GetMapping
    @Operation(
            summary = "Get all fundraising goals",
            description = "Retrieve a list of all fundraising goals (Public - no authentication required)"
    )
    ...
    @GetMapping("/{id}")
    @Operation(
            summary = "Get fundraising goal by ID",
            description = "Retrieve a fundraising goal by its ID (Public - no authentication required)"
    )
    ...
    @Operation(
            summary = "Get fundraising goals by campaign",
            description = "Retrieve all fundraising goals for a specific campaign (Public - no authentication required)"
    )
    ...
    @PostMapping
    @Operation(
            summary = "Create new fundraising goal",
            description = "Create a new fundraising goal (Fund Owner, Staff and Admin only)"
    )
    ...
    @PutMapping("/{id}")
    @Operation(
            summary = "Update fundraising goal",
            description = "Update an existing fundraising goal (Staff and Admin only)"
    )
    @PreAuthorize("hasAnyRole('STAFF', 'ADMIN')")
    public ResponseEntity<FundraisingGoal> update(@PathVariable Long id, @Valid @RequestBody UpdateFundraisingGoalRequest request) {
        return ResponseEntity.ok(fundraisingGoalService.update(id, request));
    }

    @DeleteMapping("/{id}")
    @Operation(
            summary = "Delete fundraising goal",
            description = "Delete a fundraising goal (Staff and Admin only)"
    )
    @PreAuthorize("hasAnyRole('STAFF', 'ADMIN')")
